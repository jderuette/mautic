...
use MauticPlugin\MauticFullContactBundle\Exception\API;
...
class FullContact_API extends FullContact_Person
{
    ...
    {
        if (is_null($search)) {
            throw new Base('To search, you must supply a search term.');
        }
        ...
        switch ($type) {
            ...
            case 'twitter':
                ...
                break;
            default:
                throw new API("UnsupportedLookupMethodException: Invalid lookup method specified [{$type}]");
                break;
        }
